...
urlpatterns = [
    ...
    path(
        "location/<int:pk>/close/", views.LocationClose.as_view(), name="location-close"
    ),
    ...
    path(
        "mmodelcategory/<int:pk>/close/",
        views.MmodelCategoryClose.as_view(),
        name="mmodelcategory-close",
    ),
    path(
    ...
    path(
        "itemnotecategory/<int:pk>/close/",
        views.ItemNoteCategoryClose.as_view(),
        name="itemnotecategory-close",
    ),
    path(
        "item/entity/create/",
        views.EntityCreate.as_view(),
        name="item-entity-create",
        kwargs={"popup": "popup"},
    ),
]
