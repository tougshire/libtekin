...
urlpatterns = [
    ...
    path('primary_id_count/<str:primary_id>/', views.count_primary_id, name='primary-id-count'),
    path('primary_id_count/<pk>/<str:primary_id>/', views.count_primary_id, name='primary-id-count'),
