...
class Migration(migrations.Migration):
    replaces = [
        ...
        ("libtekin", "0004_auto_20211221_2049"),
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        ...
                        null=True,
                        verbose_name="Latest Inventory Date",
                    ),
                ),
                (
                    "is_deleted",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_default",
                    models.BooleanField(
                        default=False, help_text="If this is a default"
                    ),
                ),
                (
                    "modified",
                    models.DateTimeField(
                        auto_now=True, help_text="The date this search was saved"
                    ),
                ),
                (
                    "filterstring",
                    models.TextField(blank=True, help_text="The filter string"),
                ),
                (
                    "sortstring",
                    models.CharField(
                        blank=True, help_text="The sort string", max_length=100
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text",
                    models.TextField(
                        help_text="The text of the note", verbose_name="text"
                    ),
                ),
                (
                    "when",
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="is current status",
                    ),
                ),
                (
                    "item",
        ...
        migrations.AddConstraint(
            model_name="vista",
            constraint=models.UniqueConstraint(
                fields=("user", "name"), name="unique_vista"
            ),
        ),
        migrations.DeleteModel(
            name="Vista",
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="is major or current status",
                    ),
                ),
                (
                    "item",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="The status of the load", max_length=50),
                ),
                (
                    "list_order",
                    models.IntegerField(
        ...
        migrations.AlterField(
            ...
            name="status",
            field=models.ForeignKey(
                default=libtekin.models.get_default_status,
                help_text="The status of this project",
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                to="libtekin.status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="The name of the level", max_length=50),
                ),
                (
                    "number",
                    models.IntegerField(
        ...
        migrations.AddField(
            ...
            name="level",
            field=models.ForeignKey(
                default=libtekin.models.get_default_level,
                help_text="The level of this note",
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                to="libtekin.itemnotelevel",
            ),
        ),
        migrations.RemoveField(
            model_name="itemnote",
