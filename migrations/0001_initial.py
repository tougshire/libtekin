    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_id_is', models.CharField(blank=True, choices=[('serial_number', 'Serial Number'), ('service_number', 'Service Number'), ('asset_number', 'Asset Number'), ('common_name', 'Common Name')], help_text='The identifier which is the primary id', max_length=50, verbose_name='primary id is')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_id_is', models.CharField(blank=True, help_text='By default, the field which should be used as the primary ID field (ex: "SN", "Tag Number", etc)', max_length=50, verbose_name='Primary ID is')),
                ('categories', models.ManyToManyField(help_text='The categories , such as Laptop or Phone, to which this item belongs', to='libtekin.MmodelCategory', verbose_name='categories')),
            ],
            options={
                'verbose_name': 'model',
